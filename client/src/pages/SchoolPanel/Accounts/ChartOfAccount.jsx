...
const ChartOfAccount = () => (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12 text-slate-800">
        <div className="flex justify-between items-center bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden">
            ...
            <h1 className="text-xl font-black text-navy-900 tracking-tight italic uppercase">Chart Of Account</h1>
            <div className="flex items-center space-x-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                <span>Dashboard</span>
                <span className="text-slate-200">|</span>
                <span>Accounts</span>
                <span className="text-slate-200">|</span>
                <span className="text-primary">Chart Of Account</span>
            </div>
        </div>
        ...
        <Card className="p-20 border border-snow-100 shadow-snow-sm flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div className="max-w-md">
                <h2 className="text-xl font-black text-navy-900 uppercase italic">Chart Of Accounts</h2>
                <p className="text-slate-400 font-bold mt-2">
                    Configure and manage your institution's chart of accounts for organized bookkeeping.
                </p>
            </div>
        </Card>
    </div>
