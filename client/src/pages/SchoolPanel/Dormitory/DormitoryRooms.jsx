    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex justify-between items-center px-4">
                <div>
                    <h1 className="text-xl font-black text-slate-800 tracking-tight">Dormitory Rooms</h1>
                </div>
                <div className="flex items-center space-x-2 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                    ...
                    <span>|</span>
                    <span className="text-slate-500">Dormitory Rooms</span>
                </div>
            </div>
                ...
                <Card className="p-10 border-none shadow-snow-lg bg-white rounded-[40px] h-fit">
                    ...
                    <div className="space-y-6">
                        <Select
                            ...
                            options={dormitories.map(d => ({ value: d._id, label: d.name }))}
                            required
                        />
                        <Input
                            label="ROOM NUMBER"
                        ...
                        <div className="flex justify-center pt-6">
                            <Button onClick={handleSubmit} className="bg-[#7c32ff] hover:bg-[#6b25ea] text-white rounded-2xl px-12 py-4 text-[10px] font-black uppercase tracking-widest flex items-center space-x-2 shadow-2xl shadow-purple-500/30 active:scale-95 transition-all w-full">
                                <span>✓ SAVE ROOM</span>
                            </Button>
                        </div>
                    </div>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {rooms.map((room, idx) => (
                                    <tr key={idx} className="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="py-6 px-6 text-slate-400 text-xs">{room.dormitory?.name || 'N/A'}</td>
                                        <td className="py-6 px-6 text-slate-400 text-xs">{room.roomNumber}</td>
                                        <td className="py-6 px-6 text-slate-400 text-xs">{room.type}</td>
                                        <td className="py-6 px-6 text-slate-400 text-xs">{room.numberOfBed}</td>
                                        <td className="py-6 px-6 text-slate-400 text-xs">{room.costPerBed}</td>
