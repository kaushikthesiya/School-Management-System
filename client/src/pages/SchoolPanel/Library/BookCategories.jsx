    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex justify-between items-center px-4">
                <div>
                    <h1 className="text-xl font-black text-slate-800 tracking-tight">Book Categories</h1>
                </div>
                <div className="flex items-center space-x-2 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                    ...
                    <span>|</span>
                    <span className="text-slate-500">Book Categories</span>
                </div>
            </div>
                        ...
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {categories.length > 0 ? categories.map((cat, idx) => (
                                    ...
                                    <tr>
                                        <td colSpan="3" className="py-20 text-center text-xs font-black text-slate-300 uppercase tracking-widest">
