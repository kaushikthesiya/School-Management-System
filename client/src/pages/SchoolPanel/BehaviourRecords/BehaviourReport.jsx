        ...
        <div className="space-y-6 animate-in fade-in duration-500 pb-12">
            ...
            <Card className="p-10 border-none shadow-3xl shadow-slate-100 bg-white rounded-[32px] overflow-hidden relative">
                ...
                <div className="mt-10 flex justify-end">
                    <Button className="w-full lg:w-32 bg-[#7c32ff] hover:bg-[#6b25ea] text-white rounded-xl py-4 shadow-lg shadow-purple-500/20 flex items-center justify-center space-x-2 active:scale-95 transition-all text-[10px] font-black uppercase tracking-widest">
