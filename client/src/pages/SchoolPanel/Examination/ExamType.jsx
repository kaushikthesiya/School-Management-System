...
const ExamType = () => {
    ...
    const [examTypes] = useState([
        { name: '1st Term', status: 'Active' },
        { name: '2nd Term', status: 'Active' },
        { name: 'Final Exam', status: 'Active' },
    ]);
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex justify-between items-center px-4">
                <div>
                    <h1 className="text-xl font-black text-slate-800 tracking-tight">Exam Type</h1>
                </div>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {examTypes.map((exam, idx) => (
                                    <tr key={idx} className="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="py-6 px-6 text-slate-400 text-xs">{exam.name}</td>
                                        <td className="py-6 px-6">
                                            <span className="px-3 py-1 bg-green-50 text-green-500 text-[10px] font-black rounded-full uppercase tracking-widest border border-green-100 italic">
                                                {exam.status}
                                            </span>
                                        </td>
