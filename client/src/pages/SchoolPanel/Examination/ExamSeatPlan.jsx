    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex justify-between items-center px-4">
                <div>
                    <h1 className="text-xl font-black text-slate-800 tracking-tight">Seat Plan</h1>
                </div>
                <div className="flex items-center space-x-2 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                    ...
                    <span>|</span>
                    <span className="text-slate-500">Seat Plan</span>
                </div>
            </div>
            ...
            <div className="px-4">
                <Card className="p-10 border-none shadow-snow-lg bg-white rounded-[40px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
                        ...
                        <Select label="ROOM" placeholder="Select Room *" options={['Room 101']} required />
