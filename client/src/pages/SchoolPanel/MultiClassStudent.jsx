            ...
            <Card className="p-8 border-none shadow-3xl shadow-slate-100 bg-white rounded-3xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="space-y-1.5">
                        ...
                        <Select name="academicYear" value={filters.academicYear} onChange={handleChange} options={['2024|Jan-Dec|']} placeholder="Select Year" />
                    </div>
                    <div className="space-y-1.5">
                        <Label>CLASS</Label>
                    ...
                    <div className="space-y-1.5">
                        <Label>STUDENT</Label>
                        <Select name="student" value={filters.student} onChange={handleChange} options={[]} placeholder="Select Student" />
                    </div>
                </div>
